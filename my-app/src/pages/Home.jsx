      ...
      <div className="text-white">
        <div className="max-w-[800px] mt-[-96px] w-full h-screen mx-auto text-center flex flex-col justify-center">
          <p className="text-[#8F00FF] font-bold p-2 text-xl">
            Empowering Techies Everywhere: Find Your Dream Job Near You!
          </p>
          ...
          <p className="md:text-2xl text-xl font-bold text-gray-500">
            Discover job opportunities that match your unique tech skills and
            talents. From software developers to UX designers, we've got you
            covered.
          </p>
          <Link to="/search">
