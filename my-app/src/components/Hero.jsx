  ...
  return (
    <div className='text-white'>
      <div className='max-w-[800px] mt-[-96px] w-full h-screen mx-auto text-center flex flex-col justify-center'>
        <p className='text-[#8F00FF] font-bold p-2'>Empowering Techies Everywhere: Find Your Dream Job Near You!</p>
        ...
        <div className='flex justify-center items-center'>
          ...
          <Typed className='md:text-5xl sm:text-4xl text-xl font-bold md:pl-4 pl-2' strings={['Software Developers', 'Data Scientists', 'Cybersecurity Specialists', 'UX/UI Designers']} typeSpeed={120} backSpeed={140} loop />
        </div>
